  ...
  internal = rec {
    ...
    crates = {
      ...
      "cxx" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "c++14" "c++17" "c++20" "default" "std" ];
      };
      "cxx-build" = rec {
        crateName = "cxx-build";
        version = "1.0.195";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./gen/build; };
        libName = "cxx_build";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
      ...
      "cxx-gen" = rec {
        ...
        version = "0.7.195";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./gen/lib; };
        libName = "cxx_gen";
        authors = [
      ...
      "cxx-test-suite" = rec {
        crateName = "cxx-test-suite";
        version = "0.0.1";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./tests/ffi; };
        libName = "cxx_test_suite";
        libPath = "lib.rs";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
      ...
      "cxxbridge-cmd" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./gen/cmd; };
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
        dependencies = [
          {
            ...
            packageId = "clap";
            usesDefaultFeatures = false;
            features = [ "error-context" "help" "std" "suggestions" "usage" ];
          }
          {
            name = "codespan-reporting";
            packageId = "codespan-reporting";
      ...
      "cxxbridge-flags" = rec {
        ...
        version = "1.0.195";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./flags; };
        ...
        resolvedDefaultFeatures = [ "c++14" "c++17" "c++20" "default" ];
      };
      "cxxbridge-macro" = rec {
        crateName = "cxxbridge-macro";
        version = "1.0.195";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./macro; };
        procMacro = true;
      ...
      "link-cplusplus" = rec {
        ...
        edition = "2018";
        links = "cplusplus";
        sha256 = "10lcgfp9pnxpihp21s86xnq57vpr97m2k419d8rvkl57m8qcfy3z";
      ...
      "scratch" = rec {
        ...
        version = "1.0.9";
        edition = "2015";
        sha256 = "1cj826qggwn482wbfnzij5g9p411qszai0dnfld4qzh93g2jx3yn";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
